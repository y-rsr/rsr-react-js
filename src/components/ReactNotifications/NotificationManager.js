...
class NotificationManager extends EventEmitter {
  ...
  primary(message, title, timeOut, onClick, priority, customClassName, icon) {
    this.create({
  ...
  success(message, title, timeOut, onClick, priority, customClassName, icon) {
    this.create({
  ...
  error(message, title, timeOut, onClick, priority, customClassName, icon) {
    this.create({
